...
class Picarx(object):
    ...
    """@log_on_start(logging.DEBUG , "Setting motor speed now ")
    ...
    def steering_diff_ratio(self, theta):
        if theta == 0:
            theta = 0.001
        ratio = (math.sqrt((3/math.sin(theta))**2) - 1.5) / (math.sqrt((3/math.sin(theta))**2) + 1.5)
        return ratio
    ...
    def backward(self,speed):
        ...
        diff_ratio = self.steering_diff_ratio(current_angle)
        if current_angle != 0:
    ...
    def forward(self,speed):
        ...
        if current_angle != 0:
            ...
            if (current_angle / abs_current_angle) > 0:
                ...
                # print("current_speed: %s %s"%(speed, -1*speed * power_scale222))
        else:
            self.set_motor_speed(1, speed)
            self.set_motor_speed(2, -1*speed)                  
